...
%TODO removed this section. OK?: The technique now requires us to preprocess $S$ such that we can effectively report each object in the query-set $g(q)$ defined in~\ref{eq:filtering} ~\cite{DBLP:journals/siamcomp/Chazelle86}. \begin{equation} \label{eq:filtering} g: Q \rightarrow 2^S, [g(q) = \{v \in S \mid P(v,q) \text{ is true} \} ] \end{equation}
