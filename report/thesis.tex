...
\section{General}
Everything we implemented was unit tested and large parts of the project was implemented using test driven development.

\todo{automated testing}
\todo{predicate testing}
\todo{print of tree}
\todo{sound design choices (patterns)}
\todo{random test}
\todo{checker (tree invariants)}
\todo{pair programming}
\todo{rubber duck programming}
\todo{integrated test}
\todo{stubs}
