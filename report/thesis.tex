...
\todo{fint, men en kort beskrivelse af update/tider kunne måske være god. Splits/fuses der cascader osv.}

\todo{Måske lav nogle figurer}
...
The external memory buffered priority search tree is a combination of the external memory priority search tree of Arge et al. and the buffered updates of the buffer tree also thanks to Arge~\cite{Arge:1995:BTN:645930.672850}. The data structure is described in Section~\ref{sec:main_data_structure}.
...
The experiments consist of inserting 500Mb of data. The data is uniformly random generated among the positive integers.
...
\todo{move down constant of mysql to almost bottom}
