...
\caption{The running time for different sorting algorithms. The External Heap sort by Fadel et al.~\cite{1_fadel_jakobsen_katajainen_teuhola_1999} both naive and with linear selection~\cite{2_blum_floyd_pratt_rivest_tarjan_1973}, The External Merge Sort as described in~\cite{Knuth:1997:ACP:270146}, Internal Quick Sort~\cite{qs}, and finally the Internal Heap Sort~\cite{Forsythe:1964:ALG:512274.512284}.}
