...
The strength of the weight-balanced B-Tree is the following crucial property described in the following lemma.
...
The proof, simply put, states that a node $v$ will not underflow or overflow unless $\Omega(weight(v))$ leaf elements have been inserted or deleted in the subtree of $v$ and similarly when a new root is created above the old. A proof of the lemma can be found in~\cite{arge_vitter_1996}.
\clearpage
\section{Buffer Tree}
