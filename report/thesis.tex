...
\begin{minipage}[t]{0.48\columnwidth}
  ...
  \caption{Theoretical asymptotic update time per operation for buffer sizes $B~\in~\{4\text{Kb},8\text{Kb},16\text{Kb},32\text{Kb}\}$ for Arges structure. Each graph is on the form $f(N) = \log_B N$.\todo{FIX THIS}}
