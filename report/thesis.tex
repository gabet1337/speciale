...
Also, it could be an interesting future work to optimize the space usage of the structures allowing for larger internal memory buffer sizes, and to see the effect of such optimizations on the running time.
