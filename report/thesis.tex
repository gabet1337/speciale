...
This implies we can construct the dynamic priority search in linear time assuming we are given a sorted input.
...
\todo{somehow mention that the tree becomes perfectly balanced a result of construction}
