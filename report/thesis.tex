...
\begin{enumerate}[label=(\roman*)]
	...
	\item An insertion buffer at $v$ overflows
	
	\item A point buffer overflows at $v$ when
	
	\item A node with a degree larger than .. is split
	
	\item A point buffer underflows at $v$ when
\end{enumerate}

\todo{Analysis}

\todo{Global rebuilding}
