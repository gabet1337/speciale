...
plot f(x,1024*1024/8) with lines title sprintf("buffer1MB") ls 2,\
     f(x,1024*1024/4) with lines title sprintf("buffer2MB") ls 3,\
     f(x,1024*1024/2) with lines title sprintf("buffer4MB") ls 4,\
     f(x,1024*1024) with lines title sprintf("buffer8MB") ls 5
