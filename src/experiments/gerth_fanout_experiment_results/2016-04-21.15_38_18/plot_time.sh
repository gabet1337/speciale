...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_fanout_experiment_results/2016-04-21.15_38_18/gerth_fanout2' u 1:2 t 'fanout2' w lp ls 2, \
'gerth_fanout_experiment_results/2016-04-21.15_38_18/gerth_fanout3' u 1:2 t 'fanout3' w lp ls 3, \
