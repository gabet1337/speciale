...
set output 'gerth_fanout_experiment_results/2016-05-06.11_52_24/time_slide.eps'
...
set style line 2 lc rgb '#5e9c36' pi 15 pt 5 ps 1 lt 1 lw 2 # --- green
set style line 3 lc rgb '#88419d' pi 15 pt 6 ps 1 lt 1 lw 2 # --- purple
...
set style line 6 lc rgb '#00ced1' pi 15 pt 11 ps 1 lt 1 lw 2 # --- darkturquoise
...
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout4' u 1:($2/$1) t 'fanout 4' w lp ls 3, \
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout5' u 1:($2/$1) t 'fanout 5' w lp ls 4, \
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout6' u 1:($2/$1) t 'fanout 6' w lp ls 5,\
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout8' u 1:($2/$1) t 'fanout 8' w lp ls 6,\
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout16' u 1:($2/$1) t 'fanout 16' w lp ls 7,\
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout32' u 1:($2/$1) t 'fanout 32' w lp ls 8,\
