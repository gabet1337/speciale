...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout2' u 1:($3/$1) t 'fanout 2' w lp ls 1, \
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout3' u 1:($3/$1) t 'fanout 3' w lp ls 2, \
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout4' u 1:($3/$1) t 'fanout 4' w lp ls 3, \
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout5' u 1:($3/$1) t 'fanout 5' w lp ls 4, \
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout6' u 1:($3/$1) t 'fanout 6' w lp ls 5,\
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout8' u 1:($3/$1) t 'fanout 8' w lp ls 6,\
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout16' u 1:($3/$1) t 'fanout 16' w lp ls 7,\
'gerth_fanout_experiment_results/2016-05-06.11_52_24/gerth_fanout32' u 1:($3/$1) t 'fanout 32' w lp ls 8,\
