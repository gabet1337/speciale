...
set output 'gerth_query_fanout_experiment_results/2016-06-07.14_01_52/dbo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_query_fanout_experiment_results/2016-06-07.14_01_52/gerth_fanout4' u 1:7 t 'fanout4' w lp ls 2, \
'gerth_query_fanout_experiment_results/2016-06-07.14_01_52/gerth_fanout8' u 1:7 t 'fanout8' w lp ls 3, \
'gerth_query_fanout_experiment_results/2016-06-07.14_01_52/gerth_fanout16' u 1:7 t 'fanout16' w lp ls 4