...
set output 'gerth_query_fanout_experiment_results/2016-05-15.11_05_07/pbo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_query_fanout_experiment_results/2016-05-15.11_05_07/gerth_fanout2' u 1:6 t 'fanout2' w lp ls 2