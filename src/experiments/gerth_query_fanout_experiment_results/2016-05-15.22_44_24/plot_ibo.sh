...
set output 'gerth_query_fanout_experiment_results/2016-05-15.22_44_24/ibo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_query_fanout_experiment_results/2016-05-15.22_44_24/gerth_fanout4' u 1:8 t 'fanout4' w lp ls 2