...
set output 'gerth_query_fanout_experiment_results/2016-06-08.16_03_35/pbu.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_query_fanout_experiment_results/2016-06-08.16_03_35/gerth_fanout16' u 1:9 t 'fanout16' w lp ls 2