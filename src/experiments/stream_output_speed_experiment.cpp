...
int main() {
  ...
  sose.add(1, "mmap", common::PST_VARIANT::MMAP_STREAM, 4096*4, 1);
  sose.add(2, "buffered", common::PST_VARIANT::BUFFERED_STREAM, 4096*4, 1);
  sose.add(3, "file", common::PST_VARIANT::FILE_STREAM, 4096*4, 1);
