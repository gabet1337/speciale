...
set output 'stream_output_speed_experiment_results/2016-04-23.16_07_40/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'stream_output_speed_experiment_results/2016-04-23.16_07_40/buffered_stream_buffered' u 1:5 t 'buffered' w lp ls 8, \
'stream_output_speed_experiment_results/2016-04-23.16_07_40/mmap_mmap' u 1:5 t 'mmap' w lp ls 7, \
'stream_output_speed_experiment_results/2016-04-23.16_07_40/file_stream_file' u 1:5 t 'file' w lp ls 9