...
set output 'stream_output_speed_experiment_results/2016-05-26.12_28_56/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'stream_output_speed_experiment_results/2016-05-26.12_28_56/mmap_mmap' u 1:5 t 'mmap' w lp ls 8, \
'stream_output_speed_experiment_results/2016-05-26.12_28_56/buffered_stream_buffered' u 1:5 t 'buffered' w lp ls 9, \
'stream_output_speed_experiment_results/2016-05-26.12_28_56/file_stream_file' u 1:5 t 'file' w lp ls 10