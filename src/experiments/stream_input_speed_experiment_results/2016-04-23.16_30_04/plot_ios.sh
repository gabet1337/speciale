...
set output 'stream_input_speed_experiment_results/2016-04-23.16_30_04/ios.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'stream_input_speed_experiment_results/2016-04-23.16_30_04/buffered_stream_buffered' u 1:3 t 'buffered' w lp ls 8, \
'stream_input_speed_experiment_results/2016-04-23.16_30_04/mmap_mmap' u 1:3 t 'mmap' w lp ls 7, \
'stream_input_speed_experiment_results/2016-04-23.16_30_04/file_stream_file' u 1:3 t 'file' w lp ls 9