...
set output 'stream_input_speed_experiment_results/2016-04-23.10_37_17/timems'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'stream_input_speed_experiment_results/2016-04-23.10_37_17/mmap_mmap' u 1:5 t 'mmap' w lp ls 7, \
'stream_input_speed_experiment_results/2016-04-23.10_37_17/buffered_stream_buffered' u 1:5 t 'buffered' w lp ls 8, \
'stream_input_speed_experiment_results/2016-04-23.10_37_17/file_stream_file' u 1:5 t 'file' w lp ls 9