...
set output 'stream_input_speed_experiment_results/2016-05-26.10_57_22/ars.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'stream_input_speed_experiment_results/2016-05-26.10_57_22/buffered_stream_buffered' u 1:11 t 'buffered' w lp ls 9, \
'stream_input_speed_experiment_results/2016-05-26.10_57_22/mmap_mmap' u 1:11 t 'mmap' w lp ls 8, \
'stream_input_speed_experiment_results/2016-05-26.10_57_22/file_stream_file' u 1:11 t 'file' w lp ls 10