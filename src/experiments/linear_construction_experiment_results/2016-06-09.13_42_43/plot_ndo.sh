...
set output 'linear_construction_experiment_results/2016-06-09.13_42_43/ndo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'linear_construction_experiment_results/2016-06-09.13_42_43/gerth_Gerth' u 1:10 t 'Gerth' w lp ls 2