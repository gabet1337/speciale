...
set output 'query_experiment_report_50mb_results/2016-06-07.12_22_40/ios.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-07.12_22_40/mysql_MySQL' u 1:3 t 'MySQL' w lp ls 4