...
set output 'query_experiment_report_50mb_results/2016-05-21.20_07_54/pbu.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-05-21.20_07_54/gerth_Gerth' u 1:9 t 'Gerth' w lp ls 2, \
'query_experiment_report_50mb_results/2016-05-21.20_07_54/rtree_Boost R-tree' u 1:9 t 'Boost R-tree' w lp ls 3, \
'query_experiment_report_50mb_results/2016-05-21.20_07_54/mysql_MySQL' u 1:9 t 'MySQL' w lp ls 4