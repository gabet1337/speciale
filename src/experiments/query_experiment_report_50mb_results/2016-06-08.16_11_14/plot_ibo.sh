...
set output 'query_experiment_report_50mb_results/2016-06-08.16_11_14/ibo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-08.16_11_14/gerth_Gerth' u 1:8 t 'Gerth' w lp ls 2