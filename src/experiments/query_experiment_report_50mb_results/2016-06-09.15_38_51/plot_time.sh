...
set output 'query_experiment_report_50mb_results/2016-06-09.15_38_51/time.eps'
...
set xrange [100:1200]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-09.15_38_51/gerth_Gerth' u 1:2 t 'Brodal with fanout 4' w lp ls 2