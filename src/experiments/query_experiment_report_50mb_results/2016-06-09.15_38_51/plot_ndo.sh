...
set output 'query_experiment_report_50mb_results/2016-06-09.15_38_51/ndo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-09.15_38_51/gerth_Gerth' u 1:10 t 'Gerth' w lp ls 2