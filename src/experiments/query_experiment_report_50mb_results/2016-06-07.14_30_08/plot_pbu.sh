...
set output 'query_experiment_report_50mb_results/2016-06-07.14_30_08/pbu.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-07.14_30_08/mysql_MySQL' u 1:9 t 'MySQL' w lp ls 4