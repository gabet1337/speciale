...
set output 'query_experiment_report_50mb_results/2016-06-09.15_30_40/pbu.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-09.15_30_40/arge_Arge' u 1:9 t 'Arge' w lp ls 1