...
set output 'query_experiment_report_50mb_results/2016-06-09.15_35_03/ndo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_report_50mb_results/2016-06-09.15_35_03/spatial_libspatial' u 1:10 t 'libspatial' w lp ls 6