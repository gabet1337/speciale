...
set output 'delete_experiment_results/2016-05-15.14_24_59/pbo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'delete_experiment_results/2016-05-15.14_24_59/gerth_Gerth' u 1:6 t 'Gerth' w lp ls 2