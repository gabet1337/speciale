...
set output 'delete_experiment_results/2016-06-05.16_07_15/ndo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'delete_experiment_results/2016-06-05.16_07_15/gerth_Gerth' u 1:10 t 'Gerth' w lp ls 2