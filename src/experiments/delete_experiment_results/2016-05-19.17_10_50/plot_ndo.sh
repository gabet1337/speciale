...
set output 'delete_experiment_results/2016-05-19.17_10_50/ndo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'delete_experiment_results/2016-05-19.17_10_50/internal_Internal' u 1:10 t 'Internal' w lp ls 5