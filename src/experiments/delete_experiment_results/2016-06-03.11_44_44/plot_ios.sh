...
set output 'delete_experiment_results/2016-06-03.11_44_44/ios.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'delete_experiment_results/2016-06-03.11_44_44/mysql_MySQL' u 1:3 t 'MySQL' w lp ls 4