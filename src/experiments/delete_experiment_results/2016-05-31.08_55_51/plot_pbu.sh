...
set output 'delete_experiment_results/2016-05-31.08_55_51/pbu.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'delete_experiment_results/2016-05-31.08_55_51/gerth_Gerth' u 1:9 t 'Gerth' w lp ls 2, \
'delete_experiment_results/2016-05-31.08_55_51/rtree_Boost R-tree' u 1:9 t 'Boost R-tree' w lp ls 3