#!/usr/bin/gnuplot
set terminal postscript eps enhanced color size 3,1 font 'Verdana,12'
set output 'delete_experiment_results/2016-05-31.08_55_51/time2_slide.eps'
...
set style line 2 lc rgb '#5e9c36' pi 2 pt 6 ps 1 lt 1 lw 2 # --- green
set style line 3 lc rgb '#88419d' pi 2 pt 2 ps 1 lt 1 lw 2 # --- purple
...
plot 'delete_experiment_results/2016-05-31.08_55_51/gerth_Gerth' u (400-$1):(delta_1($2)) t 'Brodal' w lp ls 2 , \
     'delete_experiment_results/2016-05-31.08_55_51/rtree_Boost R-tree' u (400-$1):(delta_3($2)) t 'Boost R-tree' w lp ls 3