...
set output 'delete_experiment_results/2016-05-17.16_49_24/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'delete_experiment_results/2016-05-17.16_49_24/arge_Arge' u 1:5 t 'Arge' w lp ls 1