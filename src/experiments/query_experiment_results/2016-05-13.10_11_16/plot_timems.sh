...
set output 'query_experiment_results/2016-05-13.10_11_16/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'query_experiment_results/2016-05-13.10_11_16/gerth_Gerth' u 1:5 t 'Gerth' w lp ls 2