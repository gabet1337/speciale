...
set output 'arge_buffer_size_experiment_results/2016-04-28.10_03_24/pfs.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'arge_buffer_size_experiment_results/2016-04-28.10_03_24/arge_buffer8192' u 1:4 t 'buffer8192' w lp ls 1, \
'arge_buffer_size_experiment_results/2016-04-28.10_03_24/arge_buffer16384' u 1:4 t 'buffer16384' w lp ls 2, \
'arge_buffer_size_experiment_results/2016-04-28.10_03_24/arge_buffer32768' u 1:4 t 'buffer32768' w lp ls 3