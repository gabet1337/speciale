...
set output 'insert_experiment_results/2016-05-27.10_58_31/ars.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-27.10_58_31/rtree_Boost R-tree' u 1:11 t 'Boost R-tree' w lp ls 3