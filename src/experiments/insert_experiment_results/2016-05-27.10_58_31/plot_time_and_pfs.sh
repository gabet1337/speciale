...
set style line 3 lc rgb '#88419d' pi 52 pt 2 ps 1 lt 1 lw 2 # --- purple
set style line 4 lc rgb '#225ea8' pt 3 ps 1 lt 1 lw 2 # --- blue
set style line 5 lc rgb '#000000' pi 52 pt 4 ps 1 lt 1 lw 2 # --- black
...
plot 'insert_experiment_results/2016-05-27.10_58_31/rtree_Boost R-tree' u 1:($2/($1*$1)) t 'time' w lp ls 5 axes x1y1 ,\
     'insert_experiment_results/2016-05-27.10_58_31/rtree_Boost R-tree' u 1:($4/($1*$1)) t 'page faults' w lp ls 3 axes x2y2
