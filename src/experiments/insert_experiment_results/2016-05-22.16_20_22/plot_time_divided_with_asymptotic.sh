...
set output 'insert_experiment_results/2016-05-22.16_20_22/time_divided_with_asymptotic_brodal.eps'
plot 'insert_experiment_results/2016-05-22.16_20_22/gerth_Gerth' u 1:($2/(($1*1024*1024)*f(($1*1024*1024),epsilon(2)))) notitle '' w lp ls 5
set output 'insert_experiment_results/2016-05-22.16_20_22/ios_divided_with_asymptotic_brodal.eps'
plot 'insert_experiment_results/2016-05-22.16_20_22/gerth_Gerth' u 1:($3/(($1*1024*1024)*f(($1*1024*1024),epsilon(2)))) notitle w lp ls 5
