...
set style line 5 lc rgb '#000000' pi 20 pt 4 ps 1 lt 1 lw 5 # --- black
...
set key top left
set xtics rotate by 45 offset -0.9,-1.3
...
plot 'insert_experiment_results/2016-05-22.16_20_22/gerth_Gerth' u 1:($2/(($1*1024*1024)*f(($1*1024*1024),epsilon(2)))) title 'time' w lp ls 5 axes x1y1,\
     'insert_experiment_results/2016-05-22.16_20_22/gerth_Gerth' u 1:($3/(($1*1024*1024)*f(($1*1024*1024),epsilon(2)))) title 'I/Os' w lp ls 3 axes x2y2
