...
set output 'insert_experiment_results/2016-05-22.16_20_22/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-22.16_20_22/gerth_Gerth' u 1:5 t 'Gerth' w lp ls 2