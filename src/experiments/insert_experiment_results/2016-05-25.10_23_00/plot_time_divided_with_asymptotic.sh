...
set style line 5 lc rgb '#000000' pi 5 pt 4 ps 1 lt 1 lw 5 # --- black
...
plot 'insert_experiment_results/2016-05-25.10_23_00/arge_Arge' u 1:($3/(($1*1024*1024)*(log($1*1024*1024)/log(4*1024)))) title "time" w lp ls 5 axes x1y1,\
     'insert_experiment_results/2016-05-25.10_23_00/arge_Arge' u 1:($2/(($1*1024*1024)*(log($1*1024*1024)/log(4*1024)))) title "I/Os" w lp ls 3 axes x1y2
