...
set output 'insert_experiment_results/2016-05-27.13_39_38/pfs.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-27.13_39_38/spatial_libspatial' u 1:4 t 'libspatial' w lp ls 6