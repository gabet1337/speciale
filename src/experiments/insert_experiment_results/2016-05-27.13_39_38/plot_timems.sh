...
set output 'insert_experiment_results/2016-05-27.13_39_38/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-27.13_39_38/spatial_libspatial' u 1:5 t 'libspatial' w lp ls 6