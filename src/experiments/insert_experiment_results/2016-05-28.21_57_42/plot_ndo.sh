...
set output 'insert_experiment_results/2016-05-28.21_57_42/ndo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-28.21_57_42/internal_Internal' u 1:10 t 'Internal' w lp ls 5, \
'insert_experiment_results/2016-05-28.21_57_42/rtree_Boost R-tree' u 1:10 t 'Boost R-tree' w lp ls 3, \
'insert_experiment_results/2016-05-28.21_57_42/spatial_libspatial' u 1:10 t 'libspatial' w lp ls 6, \
'insert_experiment_results/2016-05-28.21_57_42/mysql_MySQL' u 1:10 t 'MySQL' w lp ls 4