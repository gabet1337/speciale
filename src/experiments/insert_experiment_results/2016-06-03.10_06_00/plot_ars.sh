...
set output 'insert_experiment_results/2016-06-03.10_06_00/ars.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-06-03.10_06_00/internal_Internal' u 1:11 t 'Internal' w lp ls 5, \
'insert_experiment_results/2016-06-03.10_06_00/rtree_Boost R-tree' u 1:11 t 'Boost R-tree' w lp ls 3, \
'insert_experiment_results/2016-06-03.10_06_00/spatial_libspatial' u 1:11 t 'libspatial' w lp ls 6, \
'insert_experiment_results/2016-06-03.10_06_00/mysql_MySQL' u 1:11 t 'MySQL' w lp ls 4