...
set output 'insert_experiment_results/2016-06-09.15_15_43/time.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-06-09.15_15_43/gerth_Gerth' u 1:2 t 'Gerth' w lp ls 2