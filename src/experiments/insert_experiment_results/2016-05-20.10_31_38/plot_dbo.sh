...
set output 'insert_experiment_results/2016-05-20.10_31_38/dbo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-20.10_31_38/gerth_Gerth' u 1:7 t 'Gerth' w lp ls 2, \
'insert_experiment_results/2016-05-20.10_31_38/arge_Arge' u 1:7 t 'Arge' w lp ls 1