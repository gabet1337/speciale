...
set output 'insert_experiment_results/2016-05-21.14_06_50/timems.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-21.14_06_50/arge_Arge' u 1:5 t 'Arge' w lp ls 1