...
set output 'insert_experiment_results/2016-05-27.12_06_22/time.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'insert_experiment_results/2016-05-27.12_06_22/internal_Internal' u 1:2 t 'Internal' w lp ls 5