...
set output 'gerth_buffer_size_experiment_results/2016-05-28.10_33_24/pbu.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_buffer_size_experiment_results/2016-05-28.10_33_24/gerth_32Mb' u 1:9 t '32Mb' w lp ls 2