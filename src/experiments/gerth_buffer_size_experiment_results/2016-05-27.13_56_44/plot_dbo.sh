...
set output 'gerth_buffer_size_experiment_results/2016-05-27.13_56_44/dbo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_buffer_size_experiment_results/2016-05-27.13_56_44/gerth_8Mb' u 1:7 t '8Mb' w lp ls 2, \
'gerth_buffer_size_experiment_results/2016-05-27.13_56_44/gerth_16Mb' u 1:7 t '16Mb' w lp ls 3