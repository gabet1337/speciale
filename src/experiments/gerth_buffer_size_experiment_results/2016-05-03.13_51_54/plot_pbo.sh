...
set output 'gerth_buffer_size_experiment_results/2016-05-03.13_51_54/pbo.eps'
...
#set xrange [0:0]
#set yrange [0:0]
plot 'gerth_buffer_size_experiment_results/2016-05-03.13_51_54/gerth_buffer1MB' u 1:6 t 'buffer1MB' w lp ls 2, \
