#!/usr/bin/gnuplot
set terminal postscript eps enhanced color size 2.5,1.75 font 'Verdana,12'
set output 'gerth_buffer_size_experiment_results/2016-05-03.13_51_54/time_slides.eps'
