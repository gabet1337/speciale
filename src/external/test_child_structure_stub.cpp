...
void test_constructor() {
  ...
  ext::child_structure_stub cs(0, 2, 0.5, get_test_points());
  print_success();
}
...
void test_constructor2() {
  ...
  ext::child_structure_stub cs(7, 2, 0.5, points);
...
void test_valid_after_constructor() {
  ...
  ext::child_structure_stub cs(1,4,0.5, get_test_points());
...
void test_valid_after_destructor() {
  ...
  ext::child_structure_stub* cs = new ext::child_structure_stub(2,4,0.5, get_test_points());
  delete cs;
  cs = new ext::child_structure_stub(2);
  assert( (cs->valid_disk() == true) && "Structure not valid on disk");
  print_success();
}
#endif

void test_error_on_no_existing_child_structure_stub() {
  print_description("starting test of error on no existing child structure ");

  ext::child_structure_stub* cs = new ext::child_structure_stub(3,4,0.5,get_test_points());
  delete cs;

  cs = new ext::child_structure_stub(3,4,0.5, get_test_points());
...
void test_flushing_L() {
  ...
  ext::child_structure_stub* cs = new ext::child_structure_stub(4,4,0.5,get_test_points());
  delete cs;
...
//   ext::child_structure_stub* cs = new ext::child_structure_stub(5,4,0.5,get_test_points());
//   cs->insert(point(2,2));
...
//   ext::child_structure_stub* cs = new ext::child_structure_stub(6,4,0.5,get_test_points());
//   cs->remove(point(2,2));
...
//   ext::child_structure_stub cs(8, 4, 0.5, points);
...
//   points.pop_back();
//   points.pop_back();
//   ext::child_structure_stub cs(12, 4, 0.5, points);
//   assert( cs.valid_memory() );
//   print_success();
// }
...
//   ext::child_structure_stub cs(9, 4, 0.5, points);
//   assert(cs.valid_memory());
//   print_success();
// }
...
//   ext::child_structure_stub cs(10, 4, 0.5, points);
//   assert(cs.valid_memory());
...
//   sort(points.begin(), points.end());
//   ext::child_structure_stub cs(11, 4, 0.5, points);
//   assert(cs.valid_memory());
...
//   ext::child_structure_stub* cs = new ext::child_structure_stub(13, 4, 0.5, points);
//   assert(cs->valid_memory());

//   delete cs;

//   cs = new ext::child_structure_stub(13);
//   assert(cs->valid_memory());
...
//   vector<point> points;
//   ext::child_structure_stub cs(14,2,0.5,points);
//   assert(cs.valid_memory());
...
//   vector<point> points;
//   ext::child_structure_stub cs(15,2,0.5,points);
//   assert(cs.valid_memory());
...
//   vector<point> points;
//   ext::child_structure_stub *cs = new ext::child_structure_stub(17,2,0.5,points);
//   assert(cs->valid_memory());
...
//   cs = new ext::child_structure_stub(17);
...
//   vector<point> points;
//   ext::child_structure_stub cs(16,2,0.5,points);
//   assert(cs.valid_memory());
...
//   vector<point> points;
//   ext::child_structure_stub cs(18,2,0.5,points);
//   assert(cs.valid_memory());
...
//   vector<point> points;
//   ext::child_structure_stub *cs = new ext::child_structure_stub(19,2,0.5,points);
//   assert(cs->valid_memory());
...
//   points.push_back(point(1,1));
//   ext::child_structure_stub *cs = new ext::child_structure_stub(20,2,0.5,points);
//   assert(cs->valid_memory());
...
//   points.push_back(point(0,0));
//   points.push_back(point(1,1));
//   ext::child_structure_stub *cs = new ext::child_structure_stub(21,2,0.5,points);
//   assert(cs->valid_memory());
...
void test_report() {
  ...
  vector<point> points = get_gerth_points();
  sort(points.begin(), points.end());
  ext::child_structure_stub cs(22,2,0.5,points);
  assert(cs.valid_memory());
...
void test_report_2() {
  ...
  vector<point> points = get_gerth_points();
  sort(points.begin(), points.end());
  ext::child_structure_stub cs(23,2,0.5,points);
  assert(cs.valid_memory());
...
void test_report_3() {
  ...
  vector<point> points = get_gerth_points();
  sort(points.begin(), points.end());
  ext::child_structure_stub cs(24,2,0.5,points);
  assert(cs.valid_memory());
...
void test_report_4() {
  ...
  vector<point> points = get_gerth_points();
  sort(points.begin(), points.end());
  ext::child_structure_stub cs(25,2,0.5,points);
  assert(cs.valid_memory());
...
void test_report_insert_delete_buffer_not_empty() {
  ...
  vector<point> points = get_gerth_points();
  sort(points.begin(), points.end());
  ext::child_structure_stub cs(26,2,0.5,points);
  assert(cs.valid_memory());
...
#undef DEBUG  
  ext::child_structure_stub cs(27,1000,0.5,std::vector<point>());
...
void test_random_points() {
  ...
  ext::child_structure_stub cs(28,13,0.5,std::vector<point>(points.begin(),points.end()));
...
void test_random_points_interleaved() {
  ...
  ext::child_structure_stub cs(29,13,0.5,std::vector<point>(points.begin(),points.end()));
...
void test_random_points_with_flush() {
  ...
  ext::child_structure_stub* cs =
    new ext::child_structure_stub(30,13,0.5,std::vector<point>(points.begin(),points.end()));

  delete cs;

  cs = new ext::child_structure_stub(30);
...
void test_grid_points() {
  ...
  ext::child_structure_stub cs(31, 1024, 0.5, grid_points);
...
void test_figure_points() {
  ...
  sort(points.begin(),points.end());
  ext::child_structure_stub cs(32, 4, 0.5, points);
  print_success();
}
...
#endif
  // test_error_on_no_existing_child_structure_stub();
  // test_flushing_L();
